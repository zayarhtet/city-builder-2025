...
public class Bank {
     ...
     * 
     * Generates a transaction based on parameters subtracts the required amount from the
     * budget.
     * 
     * @param reason where the amount was spents (building roads/buildings/maintenance ect.)
